...
\section*{Convenient Interface to Inverse Ising (ConIII): A Python 3 package for solving maximum entropy models}

\rule{\textwidth}{1pt}

\section*{Paper Authors}

\textcolor{blue}{1. Lee, Edward D.; \\
2. Daniels, Bryan C..}

\section*{Paper Author Roles and Affiliations}
\textcolor{blue}{1. Department of Physics, 142 Sciences Dr, Cornell University, Ithaca NY 14853 \\
