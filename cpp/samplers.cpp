...
//// function that is needed for pickling
//py::tuple Potts3::get_value() {
//    // Refresh rng in new copy
//    return py::make_tuple(n, multipliers, -1);
//};
//
//// function that is needed for pickling
//py::tuple Potts3::get_state() {
//    return py::make_tuple(n);
//};
//
//// function that is needed for pickling
//void Potts3::set_state(py::tuple state) {
//    return;
//};
