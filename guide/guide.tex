...
\title{Convenient Interface to Inverse Ising (ConIII): A Python 3 package for solving maximum entropy models}
\author{Edward D Lee,$^1$ Bryan C Daniels$^2$}
\affiliation{$^1$Department of Physics, 142 Sciences Dr, Cornell University, Ithaca NY 14853, $^2$ASU--SFI Center for Biosocial Complex Systems, Arizona State University, Tempe, AZ 85287}
...
%\footnote{This is like early stopping \cite{}.}
