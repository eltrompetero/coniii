...
ConIII is intended to provide a centralized resource for the inverse Ising problem and easy extension to other maxent problems. Although some of the implemented algorithms are specific to the pairwise Ising model, other maxent models can be solved as well by specifying the particular constraints of the maxent model of interest. 
...
In the first few sections of this paper, we give a brief overview of maxent and describe the algorithms implemented in this package (for those unfamiliar with maxent, we also provide some useful references especially Refs~\cite{Bialek:2012ueb} and the appendix of \cite{Lee:2015ev}). Then, we describe the architecture of the package and how to contribute.
