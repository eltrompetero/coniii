...
From this Bayesian formulation, it becomes clear that the issues of compression and overfitting are both contained in this prior. The prior can inform us how believable the data points are (is the data really telling us that we are wrong?).
...
There are a number of ways to consider how models compare with one another like the Bayesian Information Criterion (BIC) and Akaike Information Criterion (AIC) \cite{Lee:2015ev}.
